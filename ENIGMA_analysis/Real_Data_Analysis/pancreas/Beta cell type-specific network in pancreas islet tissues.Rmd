...
#pancreas_deconv = MIND::bMIND2(G, frac = Fra_pancreas$theta, profile=sig,  ncore = 5, noRE = F) ### this step would be costed for a long time, to reproduce our results, user could using following code
