---
title: "Deconvolution Analysis for Arthritis Patients2"
author: "Weixu Wang"
date: "2022/1/25"
...
#deconv = bMIND(G, frac = Fra_ra2$theta, profile=sig, ncore = 5)
...
#deconv = bMIND(G, frac = Fra_ra2$theta, profile=sig, ncore = 5)
#This step would run for a long time, to ensure reproduce, user could use our learned results
deconv2 = readRDS("/mnt/data1/weixu/RA/deconv2.rds")
...
```{r, include=FALSE}
png("concordance_facs.png",res=300,height=1500,width=3500)
p1
dev.off()
```
...
```{r, include=FALSE}
png("concordance_single_cell.png",res=300,height=1500,width=3500)
p1
dev.off()
```
