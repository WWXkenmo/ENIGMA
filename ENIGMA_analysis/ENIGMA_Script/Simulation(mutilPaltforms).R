...
ref_seqwell=readRDS("/path/to/Data/ref_seqwell_rmbe.rds")
ref_drops=readRDS("/path/to/Data/ref_drop_rmbe.rds")
ref_10x=readRDS("/path/to/Data/ref_10x_rmbe.rds")
ref_indrop=readRDS("/path/to/Data/ref_indrop_rmbe.rds")
ref_smart=readRDS("/path/to/Data/ref_smart_rmbe.rds")
ref_same10x=readRDS("/path/to/Data/ref_same10x_rmbe.rds")
